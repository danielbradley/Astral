...
/*** !!! Autogenerated from source/mtx/SymbolDB.mtx !!! ***/
...
private: openxds::adt::IDictionary<openxds::adt::IEntry<CompilationUnit> >* symbols;
...
public: openxds::adt::IDictionary<openxds::adt::IEntry<CompilationUnit> >*
          importedSymbols( const openxds::adt::IList<openxds::base::String>& imports ) const;

public: openxds::adt::IDictionary<openxds::adt::IEntry<CompilationUnit> >& getSymbols() const { return *this->symbols; }
